...
import StaffRegistrationForm from "@/components/check-status/StaffRegistrationForm";

type StaffRegistrationModalProps = {
  open: boolean;
  onClose: () => void;
};
    ...
    <div className="fixed inset-0 z-50 flex items-start justify-center overflow-y-auto px-4 py-8 md:items-center md:py-12">
      ...
      <div className="relative z-10 w-full max-w-xl">
        ...
        >
          ...
          <StaffRegistrationForm onSuccess={onClose} />
        </div>
      </div>
    </div>
  );
